<?php
  ...
  if (isset ($_POST["login"])){
    ...
    $result = mysqli_query($conn, "SELECT * FROM tb_pelanggan WHERE nama_pelanggan = '$nama_pelanggan'");
                  ...
                  <form class="row g-3 needs-validation" novalidate action="" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="text" name="nama_pelanggan" class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="no_hp" class="form-control" id="yourPassword" required>
