    ...
    <section class="section">
      <div class="row">
        ...
        ?>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Isi Data Barang</h5>

              <!-- Floating Labels Form -->
              <form class="row g-3" method="post" action="" enctype="multipart/form-data">
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" name="nama_barang" placeholder="Your Name">
                    <label for="floatingName">Nama Barang</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="number" class="form-control" id="floatingEmail" name="stok" placeholder="Your Email">
                    <label for="floatingEmail">Stok</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating">
                ...
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-6 col-form-label">File Upload</label>
                  <div class="col-sm-15">
